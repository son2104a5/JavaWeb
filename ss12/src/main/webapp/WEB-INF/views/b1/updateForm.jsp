...
<div class="bg-white p-8 rounded-xl shadow-md w-full max-w-4xl">
    <h2 class="text-2xl font-semibold mb-6 text-gray-800">Update Student</h2>
    <form:form modelAttribute="student" action="/students/edit" method="post" class="space-y-4">
        <form:hidden path="id"/>
        <div>
            <label class="block text-sm font-medium text-gray-700">Name</label>
            <form:input path="name" placeholder="Name" value="${student.name}"
        ...
        <div>
            ...
            <form:input path="email" placeholder="Email" value="${student.email}"
                        cssClass="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"/>
            <form:errors path="email" class="text-red-500 text-sm mt-1"/>
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700">Date of Birth</label>
            <form:input type="date" path="dob" value="${student.dob}"
                        cssClass="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"/>
